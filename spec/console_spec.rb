RSpec.describe Console do
  ...
  describe '#start' do
    ...
    context 'with correct outout' do
      it do
        ...
        I18n.t('introduction').each_value { |phrase| expect(current_subject.outputer).to receive(:puts).with(phrase) }
  ...
  describe '#create' do
    ...
    context 'with success result' do
      ...
      it 'write to file Account instance' do
        stub_const('FileLoader::FILE_PATH', OVERRIDABLE_FILENAME)
        current_subject.create
  ...
  describe '#show_cards' do
    ...
    it 'outputs error if there are no active cards' do
      ...
      expect(current_subject.outputer).to receive(:puts).with(I18n.t(:no_cards))
  ...
  describe '#create_card' do
    ...
    context 'with correct outout' do
      it do
        I18n.t('create_card').each_value { |phrase| expect(current_subject.outputer).to receive(:puts).with(phrase) }
        current_subject.instance_variable_set(:@current_account, account)
